...
.data
    msg0 db 'Menu$'
    msg1 db 10,13,'1) Enter 1st 16-bit number$'
    msg2 db 10,13,'2) Enter 2nd 16-bit number$'
    ...
    msg8 db 10,13,'Enter 1st 16-bit number: $'
    msg9 db 10,13,'Enter 2nd 16-bit number: $'
